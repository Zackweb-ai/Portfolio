...
export default function First_section() {
  ...
  return (
      <div className='container-fluid pad-top height-f'>
          <div  className="row">
        <div ref={myRef} className={`${show? 'animate__animated  animate__slideInUp' :'' } col-md-4 d-flex align-items-center justify-content-center flex-column text-center`}>
        ...
        <div  className={`${show? 'animate__animated  animate__slideInUp animate__delay-1s first' :'' } col-md-4 d-flex align-items-center justify-content-center flex-column text-center`}>
        <img src={quality} alt="pixel" />
          <h3 className='secondary pt-3'>High Quality</h3>
          <p className='F-1-with pt-3'>Most common methods for designing websites that work well on desktop is responsive and adaptive design.</p>
        
        </div>
        <div className={`${show? 'animate__animated animate__slideInUp animate__delay-2s second' :'' } col-md-4 d-flex align-items-center justify-content-center flex-column text-center`}>
